// Generated from genre_discogs400-discogs-effnet-1.json's "classes" field
// (essentia.upf.edu/models/, CC BY-NC-ND 4.0). 400 raw Discogs genre/style labels,
// not yet run through the versioned-YAML normalisation TASKS.md still lists separately.
#pragma once

namespace mira {

constexpr int kGenreClassCount = 400;
constexpr const char* kGenreClassNames[kGenreClassCount] = {
    "Blues---Boogie Woogie",
    "Blues---Chicago Blues",
    "Blues---Country Blues",
    "Blues---Delta Blues",
