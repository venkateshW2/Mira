...
void printUsage() {
    std::cout <<
        ...
        "            [--clear] [--db <path>]\n"
        "        --material/--world/--harmonic/--signature are CAPTION-TAGGING.md's\n"
        "        controlled vocabularies (caption/TagVocabulary.h) -- fixed lists, not\n"
        "        free text, so a style LoRA is never taught two spellings of one idea.\n"
        "        They fold into `keywords`; --world takes one or two, comma-separated.\n"
        "        Pass an invalid value to have the valid ones printed. Same choices as\n"
        "        mira_ui's folder right-click -> Tag Folder...\n"
